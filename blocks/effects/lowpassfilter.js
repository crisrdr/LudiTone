Blockly.Blocks['effect_lowpassfilter'] = {
    init: function () {
        ...
        this.setColour(290);
        this.setTooltip('Aplica un filtro de pasa baja modulado por un LFO. Controla la frecuencia base del filtro, el rango de barrido en octavas y la velocidad de modulación.');
    }
};
