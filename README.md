...
| Nivel | Contenido |
|-------|-----------|
| **Básico** | Notas simples, duración y volumen |
| **Intermedio** | Acordes, semitonos, forma de onda y estructuras de control |
| **Avanzado** | Síntesis completa: ADSR, armónicos, efectos de señal |
| **Live** | Edición en tiempo real con todos los bloques disponibles |
| **Crear Sonido** | Diseño y guardado de bloques de sonido personalizados |
...
| Google Blockly | Programación visual por bloques |
| Tone.js | Síntesis de audio en el navegador |
| Local Storage API | Persistencia entre sesiones |
...
Publicado bajo licencia **GPL-3**.  
Consulta los términos en [gnu.org/licenses/gpl-3.0](https://www.gnu.org/licenses/gpl-3.0.html).
